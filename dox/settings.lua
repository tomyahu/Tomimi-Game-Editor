...
2. add the value to the 'tRet' table in the 'docs.dox.parse.processBlock()' function in the 'parse.lua' file.
3. Edit the 'docs.dox.html.buildModule()' function in the 'html.docs.dox' file to include the new Type
