...
@func appendBody
@desc Adds the input string to the docs.dox.PageVars.Body variable.
...
@scope local
@desc Used by 'docs.dox.html.buildModule()' to insert mod info detail list items.
...
--[[!
@module docs.dox.html
@func docs.dox.html.buildIndex
@desc Called from the Dox file contructor functions for each module in the 'docs.dox.Modules' table. It is responsible for building and returning the html used in the 'index.html' page.
...
local tMeta = getmetatable(tModules);
	...
	--reset the 'docs.dox.PageVars.Body' variable
	dox.PageVars.Body = "";
	...
	--the welcome page
	appendBody(tab(5, true)..'<iframe id="module" name="module" src="docs.dox/welcome.html"></iframe>');
...
--[[!
@module docs.dox.html
@func docs.dox.html.buildModule
@desc Called from the Dox file contructor functions for each module in the 'docs.dox.Modules' table. It is responsible for building and returning the html used in each module file.
...
local tModule = dox.Modules[sModule];
	...
	--set the page title
	--docs.dox.PageVars.Title = "Dox: "..sModule;
...
--[[!
@module docs.dox.html
@func docs.dox.html.buildWelcome
